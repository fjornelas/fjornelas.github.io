...
<div style="display: flex; justify-content: flex-start; align-items: flex-start;">
    <div style="flex: 2; padding-right: 20px;">
        ...
        <img src="https://github.com/fjornelas/FJOwebsite/blob/main/images/ornelas_et_al_2024a_image1.png?raw=true" alt="Data Collection Photo" style="width: 50%; height: auto; margin-bottom: 10px;">
